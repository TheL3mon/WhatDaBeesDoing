...
public class BeeManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        int deadBlueBeeCount = 0;
        int deadYellowBeeCount = 0;
        ...
        if (true)
        {
            var blueBeesToSpawm = (startBeeCount - (startBeeCount - deadBlueBeeCount));
            var yellowBeesToSpawn = (startBeeCount - (startBeeCount - deadYellowBeeCount));

            for (int i = 0; i < blueBeesToSpawm; i++)
            {
                SpawnBee(0);
            }

            for (int i = 0; i < yellowBeesToSpawn; i++)
            {
                SpawnBee(1);
            }
            spawnEnemyBeeCounter = 0.0f;

            //Debug.Log("Bee count blue: " + blueBeesToSpawm + ", yellow:" + yellowBeesToSpawn);
        }



        //Debug.Log("Bees to spawn: " + (startBeeCount - (startBeeCount - deadBeeCount)));
